...
OBJECTS = kernel/loader.o kernel/kmain.o kernel/kernel_asm.o \
	kernel/drivers/io/fb_io.o kernel/drivers/io/kprint.o kernel/drivers/io/io_ports.o \
	...
	kernel/drivers/disk/disk.o kernel/drivers/fs/file.o \
	kernel/drivers/fs/path_parser.o kernel/drivers/disk/disk_streamer.o \
	kernel/drivers/fs/ramfs/ramfs.o kernel/drivers/fs/neofs/neofs.o \
	kernel/panic.o \
...
disk_contents: output/disk.img
	...
	./fstools/copy.neofs --disk output/disk.img if=userland/execs/pwd/output/pwd.elf 			trgt=execs/pwd 	 	--flags rx
...
userland_execs:
	...
	cd ./userland/execs/pwd && $(MAKE) all
...
userland_clean:
	...
	cd ./userland/execs/pwd && $(MAKE) clean
